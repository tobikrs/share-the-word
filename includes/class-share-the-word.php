...
class Share_The_Word {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Share_The_Word_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SHARE_THE_WORD_VERSION' ) ) {
			$this->version = SHARE_THE_WORD_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'share-the-word';
	 ...
	 *
	 * - Share_The_Word_Loader. Orchestrates the hooks of the plugin.
	 * - Share_The_Word_i18n. Defines internationalization functionality.
	 * - Share_The_Word_Admin. Defines all hooks for the admin area.
	 * - Share_The_Word_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-share-the-word-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-share-the-word-i18n.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-share-the-word-public.php';

		$this->loader = new Share_The_Word_Loader();
	 ...
	 *
	 * Uses the Share_The_Word_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Share_The_Word_Loader    Orchestrates the hooks of the plugin.
	 */
